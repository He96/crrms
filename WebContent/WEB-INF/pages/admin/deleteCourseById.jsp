...
<body>
	<div class="container-fluid body">
		...
		<!-- 摘要 -->
		<div class="title">${roomName}机房课程删除操作！</div>
		<!-- 主体内容 -->
		<div class="personal col-sm-12 col-xs-12">
			<table id="deleteCourse" class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						<th>时间</th>
						<th>星期一</th>
								...
								<dd>${node1.weekWeek}</dd>
							 	...
							 	<dd>
								 	<c:if test="${node1.courseName!=null}">
								 		<a href="deleteCourseById.html?id=${node1.id}" onclick="if(confirm('确定要删除该课程?')==false)return false;">删除课表！</a>
								 	</c:if>
							 	</dd>
						  	</dl>
					 	</td>
								...
								<dd>${node2.weekWeek}</dd>
							 	...
							 	<dd>
								 	<c:if test="${node2.courseName!=null}">
								 		<a href="deleteCourseById.html?id=${node2.id}" onclick="if(confirm('确定要删除该课程?')==false)return false;">删除课表！</a>
								 	</c:if>
							 	</dd>
						  	</dl>
					 	</td>
								...
								<dd>${node3.weekWeek}</dd>
							 	...
							 	<dd>
								 	<c:if test="${node3.courseName!=null}">
								 		<a href="deleteCourseById.html?id=${node3.id}" onclick="if(confirm('确定要删除该课程?')==false)return false;">删除课表！</a>
								 	</c:if>
							 	</dd>
						  	</dl>
					 	</td>
								...
								<dd>${node4.weekWeek}</dd>
							 	...
							 	<dd>
								 	<c:if test="${node4.courseName!=null}">
								 		<a href="deleteCourseById.html?id=${node4.id}" onclick="if(confirm('确定要删除该课程?')==false)return false;">删除课表！</a>
								 	</c:if>
							 	</dd>
						  	</dl>
					 	</td>
								...
								<dd>${node5.weekWeek}</dd>
							 	...
							 	<dd>
								 	<c:if test="${node5.courseName!=null}">
								 		<a href="deleteCourseById.html?id=${node5.id}" onclick="if(confirm('确定要删除该课程?')==false)return false;">删除课表！</a>
								 	</c:if>
							 	</dd>
						  	</dl>
					 	</td>
								...
								<dd>${node6.weekWeek}</dd>
							 	...
							 	<dd>
								 	<c:if test="${node6.courseName!=null}">
								 		<a href="deleteCourseById.html?id=${node6.id}" onclick="if(confirm('确定要删除该课程?')==false)return false;">删除课表！</a>
								 	</c:if>
							 	</dd>
						  	</dl>
					 	</td>
								...
								<dd>${node7.weekWeek}</dd>
							 	...
							 	<dd>
								 	<c:if test="${node7.courseName!=null}">
								 		<a href="deleteCourseById.html?id=${node7.id}" onclick="if(confirm('确定要删除该课程?')==false)return false;">删除课表！</a>
								 	</c:if>
							 	</dd>
						  	</dl>
					 	</td>
