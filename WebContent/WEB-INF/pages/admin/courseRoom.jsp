...
<body>
	<div class="container-fluid body">
		...
		<div class="personal col-sm-9 col-xs-12">
			<div class="list-group">
				<h4><a href="javascript:void(0)" class="list-group-item active">查看课程 -- 机房选择  <span class="glyphicon glyphicon-chevron-down"></a></h4>
			</div>
			<c:forEach items="${roomNames}" var="rn">
				<div class="list-group">
					<c:if test="${rn.roomStatus==1}">
					<a href="toCourse.html?name=${rn.roomName}" style="background:#BCD2EE" class="list-group-item"> <span class="glyphicon glyphicon-ok-circle"></span> ${rn.roomName}</a>
					</c:if>
	...
	<%-- <c:forEach items="${roomNames}" var="rn">
		机房名称：<a href="toCourse.html?name=${rn.roomName }">${rn.roomName}</a><br/>
